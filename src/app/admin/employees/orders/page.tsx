...
import {
  ...
  Clock, CheckCircle, Truck, ArrowRight, User, Calendar,
  TrendingUp, Bell
} from 'lucide-react';
                ...
                <div key={order.id} className="bg-white rounded-xl p-6 shadow-sm border hover:shadow-lg transition">
                  <div className="flex flex-wrap items-start gap-4">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <span className={`px-4 py-2 rounded-full text-sm font-bold border-2 flex items-center gap-2 ${statusInfo.color}`}>
                      ...
                      {statusInfo.nextStatus && (
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition font-bold shadow-lg hover:shadow-xl"
                        >
                  ...
                  <div className="mt-4 pt-4 border-t">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {order.items?.length > 3 && (
                        <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-sm font-semibold">
                          +{order.items.length - 3} منتج
                        </span>
                      )}
                    </div>
                  </div>
